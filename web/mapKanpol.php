...
include "admin/GmapKanpol/locations_modelKanpol.php";
?>
 ...
 infoWindow = new google.maps.InfoWindow;
        ...
        for (i = 0; i < locations.length; i++) {
            marker = new google.maps.Marker({
                ...
                "<tr>\n" +
                "<td><a>Jenis:</a></td>\n" +
                "<td><textarea disabled id='manual_jenis' placeholder='Jenis'>"+locations[i][1]+"</textarea></td></tr>\n" +
                "<td><a>Nama:</a></td>\n" +
                "<td><textarea disabled id='manual_nama' placeholder='Nama'>"+locations[i][2]+"</textarea></td></tr>\n" +
                "<td><a>Alamat:</a></td>\n" +
                "<td><textarea disabled id='manual_alamat' placeholder='Alamat'>"+locations[i][3]+"</textarea></td></tr>\n" +
                "<td><a>Telp:</a></td>\n" +
                "<td><textarea disabled id='manual_telp' placeholder='Telp'>"+locations[i][4]+"</textarea></td></tr>\n" +
                "</table>\n" +
                "</div>"
            });
        ...
        function saveData(lat,lng) {
            var description = document.getElementById('manual_nama').value;
            var url = 'admin/GmapAmbulan/locations_modelKanpol.php?add_location&id_kanpol=' + id_kanpol + '&lat=' + lat + '&lng=' + lng;
