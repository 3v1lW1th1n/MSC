...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 01, 2019 at 07:04 AM
...
('FK001', 'Bed Perawatan Perina', 'RS001', 1, 23, 5),
('FK002', 'Bed Perawatan Kebidanan', 'RS001', 1, 23, 0),
('FK003', 'a', 'RS002', 1, 15, 5);
...
('RS001', 'RSUD Balaraja', 'Jl. Rumah Sakit No.88, Tobat, Balaraja, Tangerang, Banten 15126', '(021) 29508250'),
('RS002', 'RSU Selaras', '', ''),
('RS003', 'RSIA Harapan Mulia', '', ''),
('RS004', 'RS Mulia Insani', '', ''),
('RS005', 'RSIA Tiara', '', ''),
