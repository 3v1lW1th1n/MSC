						...
						<section class="panel">
							...
							<div class="panel-body">
								...
								<table class="table table-bordered table-striped mb-none" id="datatable-editable">
									...
									<a href="EinapEdit.php?id=<?php echo $d['id']; ?>" class="on-default edit-row"><i class="fa fa-pencil"></i></a>
									<a href="EinapHapus.php?id=<?php echo $d['id']; ?>" class="on-default remove-row"><i class="fa fa-trash-o"></i></a>
											</td>
										</tr>
