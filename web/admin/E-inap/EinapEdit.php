...
<!-- start: page -->
						<section class="panel">
							...
							<div class="panel-body">
								...
								<form method="post" action="?page=einap_edit" class="form-horizontal form-bordered">
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" name="d" class="form-control" id="inputDefault" value="<?php echo $d['NamaRS']; ?>"> 
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input type="text" name="b" class="form-control" id="inputDefault" value="<?php echo $d['Alamat']; ?>">
												</div>
											...
											<div class="form-group">
												...
												<div class="col-md-3">
													<input type="text" name="c" class="form-control" id="inputDefault" value="<?php echo $d['Telp']; ?>">
												</div>
											</div>
