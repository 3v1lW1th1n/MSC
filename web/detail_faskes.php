    ...
    while($d = mysqli_fetch_array($data)){
        ?>
                         ...
                         <img src="images/header_faskes2.png">   
                            <table class="display table table-bordered table-striped mb-none" id="faskes2">
    <h4><?php echo $d['nama_rs'] ?></h4>
    <h4><?php echo $d['telp_rs'] ?></h4>
  </br>

                                <thead>
                                    <tr>
                                       <input type="hidden" name="id" value="<?php echo $d['id_rs']; ?>">
                                       <th>Nama Sarana atau SDM</th>
                        ...
                        <?php 
                        include 'db/koneksi.php';
                        $data1 = mysqli_query($koneksi,"select * from tb_faskes where id_rs='$id'");
                        $c = 0;
                        ...
                        $tersedia= $a-$b;
                           ?>
                                ...
                                <tr>
                                       <td><?php echo $row['jenis_faskes']; ?></td>
                                       <td>
